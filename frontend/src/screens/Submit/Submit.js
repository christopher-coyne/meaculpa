...
const Submit = () => {
  ...
  <div className={styles.container}>
      <form className={styles.form} onSubmit={e => submitHandler(e)}>
          ...
          {errors.professor ? <FormError error={errors.professor}/> : <></>}
          ...
          {errors.course ? <FormError error={errors.course}/> : <></>}
          ...
          {errors.content ? <FormError error={errors.content}/> : <></>}
          ...
          {errors.workload ? <FormError error={errors.workload}/> : <></>}
